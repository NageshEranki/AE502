...
%{
	...
	R1, R2, R3          -   the observation site position vectorsat t1, t2, t3 (km)
	...
	rho1_old,
	rho2_old, and
    rho3_old            -   the values of the slant ranges at t1, t2, t3 at the beginning of iterative improvement (Algorithm 5.6) (km)
	diff1, diff2,
	and diff3           -   the magnitudes of the differences between the old and new slant ranges at the end of each iteration
